                ...
                <div class="panel-body">
                    ...
                    <form action="{{Route('categories.store')}}" method="post" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="categoryname" placeholder="دسته بندی کالا">
                            @csrf
                            <label for="categoryslug">نامک</label>
                            <input type="text" name="slug" class="form-control" id="categoryslug" placeholder="نامک">
